...
Call log:
  ...
  - fonts loaded
  - 15052 pixels (ratio 0.01 of all image pixels) are different.
  - waiting 100ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 9842 pixels (ratio 0.01 of all image pixels) are different.
  - waiting 250ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 4196 pixels (ratio 0.01 of all image pixels) are different.
  ...
  - main [ref=f2e64]:
    ...
    - region "大屏编辑器" [ref=f2e72]:
      - generic "编辑器工具栏" [ref=f2e73]:
        ...
        - link "预览" [ref=f2e143] [cursor=pointer]:
          - /url: /studio/screens/d53ea23a-6a1f-4257-8f37-c94244c26127/preview
        ...
        - complementary "组件与图层" [ref=f2e157]:
          - region "组件库" [ref=f2e158]:
            ...
            - region "已安装插件" [ref=f2e394]:
              ...
              - generic [ref=f2e396]:
                - heading "示例指标插件 1.0.0" [level=4] [ref=f2e397]
                - button "示例指标" [ref=f2e398]
              - generic [ref=f2e399]:
                - heading "示例指标插件 2.0.0" [level=4] [ref=f2e400]
                - button "示例指标" [ref=f2e401]
          - region "图层" [ref=f2e402]:
            - heading "图层" [level=2] [ref=f2e403]
            - button "地图 移到最底层 移到最顶层 隐藏图层 锁定图层" [ref=f2e404] [cursor=pointer]:
              - generic [ref=f2e405]: 地图
              - button "移到最底层" [ref=f2e406]: ↓
              - button "移到最顶层" [ref=f2e407]: ↑
              - button "隐藏图层" [ref=f2e408]
              - button "锁定图层" [ref=f2e412]
            - button "饼图 移到最底层 移到最顶层 隐藏图层 锁定图层" [ref=f2e416] [cursor=pointer]:
              - generic [ref=f2e417]: 饼图
              - button "移到最底层" [ref=f2e418]: ↓
              - button "移到最顶层" [ref=f2e419]: ↑
              - button "隐藏图层" [ref=f2e420]
              - button "锁定图层" [ref=f2e424]
            - button "柱状图 移到最底层 移到最顶层 隐藏图层 锁定图层" [ref=f2e428] [cursor=pointer]:
              - generic [ref=f2e429]: 柱状图
              - button "移到最底层" [ref=f2e430]: ↓
              - button "移到最顶层" [ref=f2e431]: ↑
              - button "隐藏图层" [ref=f2e432]
              - button "锁定图层" [ref=f2e436]
            - button "折线图 移到最底层 移到最顶层 隐藏图层 锁定图层" [ref=f2e440] [cursor=pointer]:
              - generic [ref=f2e441]: 折线图
              - button "移到最底层" [ref=f2e442]: ↓
              - button "移到最顶层" [ref=f2e443]: ↑
              - button "隐藏图层" [ref=f2e444]
              - button "锁定图层" [ref=f2e448]
            - button "进度 移到最底层 移到最顶层 隐藏图层 锁定图层" [ref=f2e452] [cursor=pointer]:
              - generic [ref=f2e453]: 进度
              - button "移到最底层" [ref=f2e454]: ↓
              - button "移到最顶层" [ref=f2e455]: ↑
              - button "隐藏图层" [ref=f2e456]
              - button "锁定图层" [ref=f2e460]
            - button "表格 移到最底层 移到最顶层 隐藏图层 锁定图层" [ref=f2e464] [cursor=pointer]:
              - generic [ref=f2e465]: 表格
              - button "移到最底层" [ref=f2e466]: ↓
              - button "移到最顶层" [ref=f2e467]: ↑
              - button "隐藏图层" [ref=f2e468]
              - button "锁定图层" [ref=f2e472]
            - button "指标 移到最底层 移到最顶层 隐藏图层 锁定图层" [ref=f2e476] [cursor=pointer]:
              - generic [ref=f2e477]: 指标
              - button "移到最底层" [ref=f2e478]: ↓
              - button "移到最顶层" [ref=f2e479]: ↑
              - button "隐藏图层" [ref=f2e480]
              - button "锁定图层" [ref=f2e484]
            - button "图片 移到最底层 移到最顶层 隐藏图层 锁定图层" [ref=f2e488] [cursor=pointer]:
              - generic [ref=f2e489]: 图片
              - button "移到最底层" [ref=f2e490]: ↓
              - button "移到最顶层" [ref=f2e491]: ↑
              - button "隐藏图层" [ref=f2e492]
              - button "锁定图层" [ref=f2e496]
            - button "文本 移到最底层 移到最顶层 隐藏图层 锁定图层" [ref=f2e500] [cursor=pointer]:
              - generic [ref=f2e501]: 文本
              - button "移到最底层" [ref=f2e502]: ↓
              - button "移到最顶层" [ref=f2e503]: ↑
              - button "隐藏图层" [ref=f2e504]
              - button "锁定图层" [ref=f2e508]
        - main "大屏画布" [ref=f2e512]:
          - generic [ref=f2e513]:
            - generic [ref=f2e515]:
              - button "DataPulse 运营态势总览" [ref=f2e516]
              - button [ref=f2e519]:
                - img "品牌图像" [ref=f2e522]
              - button [ref=f2e523]:
                - generic [ref=f2e525]:
                  - paragraph [ref=f2e526]: 销售总额
                  - strong [ref=f2e527]: "561"
              - button [ref=f2e528]:
                - table [ref=f2e532]:
                  - rowgroup [ref=f2e533]:
                    - row [ref=f2e534]:
                      - columnheader "month" [ref=f2e535]
                      - columnheader "region" [ref=f2e536]
                      - columnheader "amount" [ref=f2e537]
                  - rowgroup [ref=f2e538]:
                    - row [ref=f2e539]:
                      - cell "2026-01" [ref=f2e540]
                      - cell "华东" [ref=f2e541]
                      - cell "120.5" [ref=f2e542]
                    - row [ref=f2e543]:
                      - cell "2026-02" [ref=f2e544]
                      - cell "华南" [ref=f2e545]
                      - cell "80" [ref=f2e546]
                    - row [ref=f2e547]:
                      - cell "2026-03" [ref=f2e548]
                      - cell "华东" [ref=f2e549]
                      - cell "200" [ref=f2e550]
                    - row [ref=f2e551]:
                      - cell "2026-04" [ref=f2e552]
                      - cell "华北" [ref=f2e553]
                      - cell "160" [ref=f2e554]
              - button "目标值 100% 100" [ref=f2e555]:
                - generic [ref=f2e557]:
                  - generic [ref=f2e558]:
                    - generic [ref=f2e559]: 目标值
                    - strong [ref=f2e560]: 100%
                  - progressbar "目标值" [ref=f2e561]
              - button [ref=f2e563]
              - button [ref=f2e569]
              - button [ref=f2e575]
              - button [ref=f2e581]
            - generic:
              ...
              - generic: 网格 10px
              - generic: 吸附开启
        - complementary "属性面板" [ref=f2e587]:
          - region "属性面板" [ref=f2e588]:
            - heading "属性" [level=2] [ref=f2e589]
            - paragraph [ref=f2e590]: 选择一个组件后编辑属性。
          - region "AI 使用说明" [ref=f2e591]:
            - heading "AI 分析" [level=2] [ref=f2e592]
            - paragraph [ref=f2e593]: 选中一个可绑定数据的组件后，就可以生成图表建议并直接应用。
```
