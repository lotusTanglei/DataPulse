...
- Name: first-stage-creation.spec.ts >> blank creation supports hand editing, AI preview, confirmation, undo, redo, and playback
- Location: e2e/first-stage-creation.spec.ts:30:1
