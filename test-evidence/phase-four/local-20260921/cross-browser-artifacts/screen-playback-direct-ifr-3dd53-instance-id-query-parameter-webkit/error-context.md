...
- Name: screen-playback.spec.ts >> direct iframe embeds load without an instance_id query parameter
- Location: e2e/screen-playback.spec.ts:123:1

# Error details

```
Error: {"error":{"code":"SCREEN_NAME_CONFLICT","message":"A screen with this name already exists.","request_id":"4f082b5c-c16d-4ae3-ac48-89a74312d195","field_errors":[]}}
