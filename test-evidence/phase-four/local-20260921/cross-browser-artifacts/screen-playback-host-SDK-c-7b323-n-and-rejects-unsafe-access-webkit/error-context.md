...
- Name: screen-playback.spec.ts >> host SDK controls an embedded screen and rejects unsafe access
- Location: e2e/screen-playback.spec.ts:154:1

# Error details

```
Error: {"error":{"code":"SCREEN_NAME_CONFLICT","message":"A screen with this name already exists.","request_id":"b85621e3-f88a-4623-8b06-f241c3595ae7","field_errors":[]}}
