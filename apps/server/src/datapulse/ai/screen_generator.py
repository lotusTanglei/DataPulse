...
_DEFAULT_PROPS: dict[str, dict[str, JsonValue]] = {
    ...
    "builtin.gauge": {"label": "完成率", "precision": 1, "empty_text": "暂无数据"},
    "builtin.status_matrix": {"title": "运行状态", "empty_text": "暂无数据"},
    "builtin.line": {"empty_text": "暂无数据"},
    "builtin.bar": {"orientation": "vertical", "empty_text": "暂无数据"},
    "builtin.pie": {"variant": "pie", "empty_text": "暂无数据"},
    "builtin.radar": {"empty_text": "暂无数据"},
    "builtin.heatmap": {"empty_text": "暂无数据"},
    "builtin.scatter": {"empty_text": "暂无数据"},
    "builtin.funnel": {"empty_text": "暂无数据"},
    "builtin.ranking": {"title": "Top 排行", "empty_text": "暂无数据"},
    "builtin.alert_list": {"title": "实时告警", "empty_text": "暂无告警"},
    "builtin.timeline": {"title": "事件流", "empty_text": "暂无事件"},
    "builtin.geo_map": {
        "asset_id": "",
