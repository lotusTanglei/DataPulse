...
_ALLOWED_PROP_KEYS: dict[str, set[str]] = {
    ...
    "builtin.panel": {"title", "subtitle", "frame_variant", "show_grid"},
    "builtin.divider": {"orientation", "label"},
    "builtin.digital_number": {"label", "unit", "prefix", "precision", "empty_text"},
    ...
    "builtin.gauge": {"label", "precision", "empty_text"},
    "builtin.status_matrix": {"title", "empty_text"},
    "builtin.line": {"empty_text"},
    "builtin.bar": {"orientation", "empty_text"},
    "builtin.pie": {"variant", "empty_text"},
    "builtin.radar": {"title", "empty_text"},
    "builtin.heatmap": {"title", "empty_text"},
    "builtin.scatter": {"title", "empty_text"},
    "builtin.funnel": {"title", "empty_text"},
    "builtin.ranking": {"title", "empty_text"},
    "builtin.alert_list": {"title", "empty_text"},
    "builtin.timeline": {"title", "empty_text"},
    "builtin.geo_map": {
        "asset_id",
